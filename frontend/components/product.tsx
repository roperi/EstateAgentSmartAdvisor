 ...
 * @see https://v0.dev/t/dZ9mNbzzT56
 */
        ...
        <div className="flex flex-col lg:flex-row lg:space-x-6">
          ...
          <div className="lg:w-1/3 mt-6 lg:mt-0">
            ...
            <div className="flex space-x-4">
              <Button className="bg-[#00A396] text-white">Arrange a viewing</Button>
              <Button className="bg-[#00A396] text-white">Mortgage advice</Button>
            </div>
